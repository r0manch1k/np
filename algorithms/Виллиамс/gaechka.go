...
//
// Конечно, тут должно быть честное матричное умножение, потому что
// функция работает за куб, хотя могла бы быстрее, если бы было реализовано
// быстрое перемножение.
// В оригинальной статье Виллиамса, к слову, всё-таки была описана вероятностная
// оптимизация перемножения булевых матриц
